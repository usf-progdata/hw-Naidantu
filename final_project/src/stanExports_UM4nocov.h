...
namespace model_UM4nocov_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_UM4nocov");
    reader.add_event(120, 118, "end", "model_UM4nocov");
    return reader;
}
...
class model_UM4nocov
  : public stan::model::model_base_crtp<model_UM4nocov> {
private:
        int K;
        int M;
        int I;
        ...
        vector_d theta_mu;
public:
    model_UM4nocov(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_UM4nocov_namespace::model_UM4nocov";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_UM4nocov_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_UM4nocov_namespace::model_UM4nocov stan_model;
#ifndef USING_R
