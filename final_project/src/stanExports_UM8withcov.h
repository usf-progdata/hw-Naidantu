...
namespace model_UM8withcov_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_UM8withcov");
    reader.add_event(134, 132, "end", "model_UM8withcov");
    return reader;
}
...
class model_UM8withcov
  : public stan::model::model_base_crtp<model_UM8withcov> {
private:
        int K;
        int M;
        int I;
        ...
        matrix_d PC1;
public:
    model_UM8withcov(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_UM8withcov_namespace::model_UM8withcov";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_UM8withcov_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_UM8withcov_namespace::model_UM8withcov stan_model;
#ifndef USING_R
