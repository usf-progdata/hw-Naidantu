...
namespace model_UM8nocov_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_UM8nocov");
    reader.add_event(120, 118, "end", "model_UM8nocov");
    return reader;
}
...
class model_UM8nocov
  : public stan::model::model_base_crtp<model_UM8nocov> {
private:
        int K;
        int M;
        int I;
        ...
        vector_d theta_mu;
public:
    model_UM8nocov(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_UM8nocov_namespace::model_UM8nocov";
        ...
        try {
            ...
            pos__ = 0;
            I_ne = vals_i__[pos__++];
            check_greater_or_equal(function__, "I_ne", I_ne, 0);
            ...
            pos__ = 0;
            I_po = vals_i__[pos__++];
            check_greater_or_equal(function__, "I_po", I_po, 0);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_UM8nocov_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_UM8nocov_namespace::model_UM8nocov stan_model;
#ifndef USING_R
