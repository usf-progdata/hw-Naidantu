...
namespace model_UM7nocov_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_UM7nocov");
    reader.add_event(116, 114, "end", "model_UM7nocov");
    return reader;
}
...
class model_UM7nocov
  : public stan::model::model_base_crtp<model_UM7nocov> {
private:
        int K;
        int M;
        int I;
        ...
        vector_d theta_mu;
public:
    model_UM7nocov(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_UM7nocov_namespace::model_UM7nocov";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_UM7nocov_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_UM7nocov_namespace::model_UM7nocov stan_model;
#ifndef USING_R
